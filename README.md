...
You can download the artifact manually from [Sonatype Nexus](https://oss.sonatype.org/service/local/repositories/releases/content/com/lukaspradel/steam-web-api/1.6.0/steam-web-api-1.6.0.jar) or [Maven Central](https://repo1.maven.org/maven2/com/lukaspradel/steam-web-api/1.6.0/steam-web-api-1.6.0.jar).
...
- Version 1.6.1: Replace the internally used HTTP Client from Apache httpclient5 to java.net.http (needs Java 11)
